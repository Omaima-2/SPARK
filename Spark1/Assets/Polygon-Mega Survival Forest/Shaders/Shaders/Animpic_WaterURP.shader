...
Shader "Animpic/Animpic_WaterURP"
{
	Properties
	{
	...
	SubShader
	{
        ...
        Pass
        {
			...
			uniform float4 _CameraDepthTexture_TexelSize7;
...
ASEEND*/
//CHKSM=1EF85A664B2EB2546DB0971CC9D5DFCA96607C86